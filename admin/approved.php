...
<html >
	<head>
		...
		<title>Εγκεκριμένα σχόλια</title>
            ...
            <?php include 'header.php';?>
	          ...
	          <div id="content">
	            <header class="clearfix">
	              <h2 class="page_title pull-left"><?php if(isset($_POST['subject-comments'])){ $code=$_POST['comments-title']; echo 'Σχόλια για το μάθημα: '.$code;}else echo "Όλα τα σχόλια";  ?></h2>
	            ...
	            <?php 
					...
					if(isset($_POST['subject-comments'])){
						$code=$_POST['subject-comments'];
						$sql="SELECT image_name,name,title,timedate,content,comment_id FROM comment,user,subject WHERE comment_username=username and subject_code=code and approved='1' and subject_code='$code';";


					}else{
						$sql="SELECT image_name,name,title,timedate,content,comment_id FROM comment,user,subject WHERE comment_username=username and subject_code=code and approved='1';";
	            	...
	            	<div class=" commentarea col-sm-10 col-md-11">
						...
						<div class="well well-sm comments-well">
			      		...
			      		if(isset($_SESSION["admin"])){ echo '<div class="clearfix">
			      			<div class="pull-right">
			      				<a class="btn btn-xs btn-default unapprove_comment" href="#" role="button" name="'.$row['comment_id'].'"><span class="glyphicon glyphicon-thumbs-down" aria-hidden="true"></span>&nbsp;Un-approve</a>
