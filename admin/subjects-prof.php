        ...
        <div class="col-md-10 col-sm-11  display-table-cell vertical-align-top" >
          ...
          <div class="hidden-sm hidden-xs" id="content">
                ...
                while($row = mysqli_fetch_array($result)) {
                  ...
                  if($i>0){
                    ...
                    echo '<tr>
                        ...
                        <td class="hidden-xs hidden-sm"><button type="button" class="btn btn-xs btn-warning prof-subject" id="'.$row['code'].'">Edit</button></td>
            ...
            <div class="btn btn-primary go-back">Back</div>
                ...
                <div class="row">
                  <div class="col-md-6 general-info ">
                    ...
                    <h3 class="subject-title"></h3>
                        ...
                        <div class="description" data-prof="<?php echo $_SESSION['username']; ?>">
                          <b class="">Περιγραφή: </b><br>
                          <div   class="subject-description"  rows="25" style="width: 100%;">
                            
                          </div> 
                          <div class="btn btn-primary" id="save-description" style="display: none;" >Save</div> <br>
                        </div>
                        <span>
                          <div  >
                ...
                <div class="col-md-6 teachers pull-right">
