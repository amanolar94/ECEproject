            ...
            <table class="table table-hover all-subjects" style="display:inline-block;">
              <thead>
                <tr>
                  ...
                  <th class="hidden-xs hidden-sm">Επεξεργασία</th>
                ...
                while($row = mysqli_fetch_array($result)) {
                  ...
                  if($i>0){
                    ...
                    echo '<tr>
                        ...
                        <td class="hidden-xs hidden-sm"><button type="button" class="btn btn-xs btn-warning edit-subject" id="'.$row['code'].'">Edit</button></td>
            ...
            <div class="btn btn-primary go-back">Back</div>
                ...
                <h3 class="subject-title"></h3>
                    ...
                    <span>
                      ...
                      <div class="btn btn-primary change-ects" style="display: none;">Αποθήκευση αλλαγών</div>
                    </span><br>
                    <span>
                          ...
                          require 'phpplugins/database_connect.php';
                            ...
                            if ($result->num_rows > 0) {
                                ...
                                while($row = $result->fetch_assoc()) {
                                    ...
                                    echo '<option name="option-subject" value="'.$class_id.'">'.$class_name.'</option>';
                ...
                <div class="btn btn-primary add-teacher" data-id="123">Προσθήκη Διδάσκοντα</div>
