...
<html lang="en">
  ...
  <body>
                            ...
                            <ul>
                              <li class="events-group" >
                                ...
                                <ul id="monday">
                                  ...
                                  <?php   
                                    ...
                                    $sql="SELECT code,title,type,DATE_FORMAT(beginning_time, '%H:%i') AS start,DATE_FORMAT(end_time, '%H:%i') AS end FROM subject,teaching,attends WHERE code=teaching_subject_code AND teaching_day='Monday' AND semester='$eksamino' AND teach_year='$etos' AND subjectsectorid='$tomeas' AND username='$username' and on_schedule='1' and subject_code=teaching_subject_code ;";
                              ...
                              <li class="events-group" >
                                ...
                                <ul id="tuesday">
                                   <?php   
                                    ...
                                    $username=$_SESSION["username"];
                                    $sql="SELECT code,title,type,DATE_FORMAT(beginning_time, '%H:%i') AS start,DATE_FORMAT(end_time, '%H:%i') AS end FROM subject,teaching,attends WHERE code=teaching_subject_code AND teaching_day='Tuesday' AND semester='$eksamino' AND teach_year='$etos' AND subjectsectorid='$tomeas' AND username='$username' and on_schedule='1' and subject_code=teaching_subject_code ";
                                    $result = mysqli_query($conn,$sql);
                              ...
                              <li class="events-group" >
                                ...
                                <?php   
                                    ...
                                    $sql="SELECT code,title,type,DATE_FORMAT(beginning_time, '%H:%i') AS start,DATE_FORMAT(end_time, '%H:%i') AS end FROM subject,teaching,attends WHERE code=teaching_subject_code AND teaching_day='Wednesday' AND semester='$eksamino' AND teach_year='$etos' AND subjectsectorid='$tomeas' AND username='$username' and on_schedule='1' and subject_code=teaching_subject_code;";
                                    $result = mysqli_query($conn,$sql);
                              ...
                              <li class="events-group" >
                                ...
                                <ul id="thursday">
                                  <?php   
                                    ...
                                    $username=$_SESSION["username"];
                                    $sql="SELECT code,title,type,DATE_FORMAT(beginning_time, '%H:%i') AS start,DATE_FORMAT(end_time, '%H:%i') AS end FROM subject,teaching,attends WHERE code=teaching_subject_code AND teaching_day='Thursday' AND semester='$eksamino' AND teach_year='$etos' AND subjectsectorid='$tomeas' AND username='$username' and on_schedule='1' and subject_code=teaching_subject_code;";
                                    $result = mysqli_query($conn,$sql);
                                    while($row = mysqli_fetch_array($result)) {
                                      if($row['type']=='theory'){
                                        $type='math1';
                              ...
                              <li class="events-group" >
                                ...
                                <ul id="friday">
                                  <?php   
                                    ...
                                    $username=$_SESSION["username"];
                                    $sql="SELECT code,title,type,DATE_FORMAT(beginning_time, '%H:%i') AS start,DATE_FORMAT(end_time, '%H:%i') AS end FROM subject,teaching,attends WHERE code=teaching_subject_code AND teaching_day='Friday' AND semester='$eksamino' AND teach_year='$etos' AND subjectsectorid='$tomeas'AND username='$username' and on_schedule='1' and subject_code=teaching_subject_code;";
                                    $result = mysqli_query($conn,$sql);
    ...
    <script>
          $(document).ready($("#schedule-student").addClass('active'));
     </script>
    <script type="text/javascript">
