...
CREATE DATABASE IF NOT EXISTS `ecedatabase`;

ALTER DATABASE ecedatabase CHARACTER SET utf8 COLLATE utf8_general_ci;
-- -----------------------------------------------------
-- Table `ecedatabase`.`user`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ecedatabase`.`user` (
...
-- -----------------------------------------------------
-- Table `ecedatabase`.`sector`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ecedatabase`.`sector` (
...
-- -----------------------------------------------------
-- Table `ecedatabase`.`faculty`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ecedatabase`.`faculty` (
  ...
  CONSTRAINT `fid`
    ...
    REFERENCES `ecedatabase`.`user` (`username`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `facultysectorid`
    FOREIGN KEY (`facultysectorid`)
    REFERENCES `ecedatabase`.`sector` (`sector_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `ecedatabase`.`student`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ecedatabase`.`student` (
...
-- -----------------------------------------------------
-- Table `ecedatabase`.`secratery`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ecedatabase`.`secratery` (
...
-- -----------------------------------------------------
-- Table `ecedatabase`.`announcement`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ecedatabase`.`announcement` (
...
-- -----------------------------------------------------
-- Table `ecedatabase`.`tags`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ecedatabase`.`tags` (
...
-- -----------------------------------------------------
-- Table `ecedatabase`.`post`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ecedatabase`.`post` (
  ...
  CONSTRAINT `announcementid`
    ...
    REFERENCES `ecedatabase`.`announcement` (`announcement_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `secretaryusername`
    FOREIGN KEY (`secretaryusername`)
    REFERENCES `ecedatabase`.`secratery` (`secretary_username`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `tagid`
    FOREIGN KEY (`tagid`)
    REFERENCES `ecedatabase`.`tags` (`tags_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `ecedatabase`.`subject`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ecedatabase`.`subject` (
...
-- -----------------------------------------------------
-- Table `ecedatabase`.`connected`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ecedatabase`.`connected` (
  ...
  CONSTRAINT `connected1_code`
    ...
    REFERENCES `ecedatabase`.`subject` (`code`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `ecedatabase`.`required`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ecedatabase`.`required` (
...
-- -----------------------------------------------------
-- Table `ecedatabase`.`book`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ecedatabase`.`book` (
...
-- -----------------------------------------------------
-- Table `ecedatabase`.`subjectbook`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ecedatabase`.`subjectbook` (
  ...
  CONSTRAINT `subject_book`
    ...
    REFERENCES `ecedatabase`.`book` (`isbn`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `ecedatabase`.`attends`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ecedatabase`.`attends` (
  `username` VARCHAR(10) NOT NULL,
  `subject_code` VARCHAR(10) NOT NULL,
  ...
  CONSTRAINT `username`
    ...
    REFERENCES `ecedatabase`.`student` (`student_username`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `ecedatabase`.`comment`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ecedatabase`.`comment` (
...
-- -----------------------------------------------------
-- Table `ecedatabase`.`class`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ecedatabase`.`class` (
...
-- -----------------------------------------------------
-- Table `ecedatabase`.`teaching`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ecedatabase`.`teaching` (
  ...
  CONSTRAINT `teacher_username`
    ...
    REFERENCES `ecedatabase`.`faculty` (`faculty_username`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_class_id`
    FOREIGN KEY (`class_id`)
    REFERENCES `ecedatabase`.`class` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE TABLE IF NOT EXISTS `ecedatabase`.`was_teaching` (
